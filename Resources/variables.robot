...
&{USER_CREDENTIALS}     email=admin@thr.com       password=Password@123     wrong_email=admin@gmail.com     wrong_password=123
${EMAIL_FIELD}      \#admin_user_email
${PASSWORD_FIELD}      \#admin_user_password
